...
--
-- Host: 192.168.1.168    Database: grandes_almacenes
-- ------------------------------------------------------
...
CREATE TABLE `ventas` (
  ...
  CONSTRAINT `ventas_ibfk_1` FOREIGN KEY (`id_cajero`) REFERENCES `cajeros` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `ventas_ibfk_2` FOREIGN KEY (`id_producto`) REFERENCES `productos` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `ventas_ibfk_3` FOREIGN KEY (`id_maquina`) REFERENCES `maquinas_registradoras` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2022-02-28 15:43:57
