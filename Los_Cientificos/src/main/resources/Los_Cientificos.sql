...
--
-- Host: 192.168.1.168    Database: cientificos
-- ------------------------------------------------------
...
CREATE TABLE `asignado_a` (
  ...
  CONSTRAINT `asignado_a_ibfk_1` FOREIGN KEY (`cientifico`) REFERENCES `cientificos` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `asignado_a_ibfk_2` FOREIGN KEY (`proyecto`) REFERENCES `proyectos` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `asignado_a` VALUES ('123A','123A','123A');
...
INSERT INTO `cientificos` VALUES ('123A','LUDWIG VAN BEETHOVEN');
...
INSERT INTO `proyectos` VALUES ('123A','música',140);
...
-- Dump completed on 2022-02-28  9:49:30
